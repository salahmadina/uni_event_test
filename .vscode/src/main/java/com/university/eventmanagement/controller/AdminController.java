...
public class AdminController {
    ...
    public String dashboard(HttpSession session, Model model) {
        ...
        long cancelledCount = allEvents.stream()
            .filter(e -> e.getStatus() == Event.Status.CANCELLED)
            .count();
    ...
    public String deleteEvent(@PathVariable Long id,
        ...
        // Soft-cancel: marks the event CANCELLED, preserves all bookings/ratings
        eventService.deleteEvent(id);
        redirectAttributes.addFlashAttribute("success", "Event cancelled and archived.");
        return "redirect:/admin/events";
    }
