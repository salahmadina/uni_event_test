...
public class EventService {
    ...
    public List<Event> getCancelledEvents() {
        return eventRepository.findByStatus(Event.Status.CANCELLED);
    }
    ...
    /**
     * Soft-delete: mark the event CANCELLED and null-out the FK on every
     * related Booking and Rating so the records survive but the event row
     * is no longer referenced.  The event itself is NOT removed from the DB.
     */
